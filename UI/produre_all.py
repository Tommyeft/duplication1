...
if __name__ == '__main__':
    ...
    plt.grid()
    # 显示图像
    save_path = r"E:\desk\biyesheji\duplication1\picture\mAP50.png"
    plt.savefig(save_path, dpi=600)   # dpi可设为300/600/900，表示存为更高清的矢量图
    plt.show()
    ...
    plt.grid()
    # 显示图像
    save_path = r"E:\desk\biyesheji\duplication1\picture\mAP50-95.png"
    ...
    plt.grid()
    # 显示图像
    save_path = r"E:\desk\biyesheji\duplication1\picture\loss.png"
    plt.savefig(save_path, dpi=600)
    plt.show()    