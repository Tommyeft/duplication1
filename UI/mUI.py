...
class FaceRecognitionWindow(QWidget):
        ...
        try:
            ...
            with ThreadPoolExecutor(max_workers=8) as executor:
                ...
                while True:
                    ...
                    # 绘制检测结果
                    self.draw_detection_results(frame, results, last_confidence_update)
    ...
    def draw_detection_results(self, frame, results, last_confidence_update):
        for box in results[0].boxes:
            if box.cls == 0:
                ...
                cv2.putText(frame, text, (x1, y1 - 10), cv2.FONT_HERSHEY_SIMPLEX, font_scale, (255, 0, 0), 2)
